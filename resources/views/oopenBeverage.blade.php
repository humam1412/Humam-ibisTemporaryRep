  ...
  <div class="row pb-5 mb-4">
    <div class="col-6 col-md-4   mb-4 mb-lg-4">
      ...
      <div class="card rounded shadow-sm border-0">
        <div class="card-body p-4" style=" text-align:center; background-image: url(images/backgroundd.jpg); background-size: cover; background-position:center;"><img src="images/jus.png" alt="" class="img-fluid d-block mx-auto mb-3">
